...
<template>
  <div class="backdrop-blur-md pt-52 pl-36 relative w-[1920px] h-[1080px] bg-cover bg-center bg-transparent text-white">
    <div class=" pt-14">
      <!-- Current Time -->
      ...
      <!-- Footer -->
      <div class="absolute bottom-12 right-12 text-sm text-justify flex space-x-2 items-center">
        <p>
          Lyrics and/or music are used by agreement with © <br />Stiftelsen Skjulte Skatters
          Forlag. All rights reserved.
        </p>
